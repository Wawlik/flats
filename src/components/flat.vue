				...
				<div class="uk-card-footer">
					<div class="uk-grid-small uk-flex-middle" uk-grid>
						<div class="uk-width-auto">
							<img uk-tooltip="Агент" v-if="isAgent(data.relationships)" class="uk-border-circle" width="40" height="40" src="../assets/agent.png">
							<img uk-tooltip="Владелец" v-else class="uk-border-circle" width="40" height="40" src="../assets/owner.jpg">
						</div>
